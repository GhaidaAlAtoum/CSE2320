/*
 *   Name : Ghaida Al-Atoum         ID#: 1001228672
 *                            HW02
 *   Compile Using : gcc -std = c99 hw02.c 
 *   asymptotic worst-case time is theta((m^2)n)
 *  Note: This Code gives the right sum for each subset but different elemnts than whats in the website 
 *            and that is due to the different backtrace approach. 
 */
	#include <stdio.h>
	#include <stdlib.h>
